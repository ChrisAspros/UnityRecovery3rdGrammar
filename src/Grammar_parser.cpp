...
G_parser::G_parser() : grammars(grammars_path, std::ifstream::in){
    ...
    grammars_path = "/Users/christodoulosaspromallis/Documents/UCL/PhD_Y_3/OF/of_v0.9.8_osx_release/apps/myApps/UnityRecovery3rdGrammar/bin/data/Unity3rdGrammarRecovery.py";
