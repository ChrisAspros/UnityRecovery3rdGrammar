...
void ofApp::setup(){
    ...
    openSans.load("/Users/christodoulosaspromallis/Documents/UCL/PhD_Y_3/OF/of_v0.9.8_osx_release/apps/myApps/UnityRecovery3rdGrammar/bin/data/open-sans/OpenSans-Regular.ttf", 19.5);
